...
const users: User[] = [
  ...
  { id: 2, name: 'Sarah Williams', email: 'sarah@example.com', role: 'User', status: 'active' },
  ...
  { id: 5, name: 'James Wilson', email: 'james@example.com', role: 'Viewer', status: 'active' },
];
...
// Mock Icons (simplified for demo)
const DashboardIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="3" y="3" width="7" height="9" rx="2" fill="currentColor" />
    <rect x="3" y="15" width="7" height="6" rx="2" fill="currentColor" />
    <rect x="13" y="3" width="8" height="6" rx="2" fill="currentColor" />
    <rect x="13" y="12" width="8" height="9" rx="2" fill="currentColor" />
  </svg>
);
...
const UserProfile = () => (
  <div style={{ 
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <span style={{ fontWeight: '500', fontSize: '14px', color: '#111827' }}>Alex Johnson</span>
      <span style={{ fontSize: '12px', color: '#6b7280' }}>alex@example.com</span>
    </div>
  </div>
);
...
export const Default: Story = {
  args: {
    sidebarProps: {
      ...
      items: [
        ...
        { label: 'Users', icon: <UsersIcon />, 
          children: [
            { label: 'All Users', active: false },
            { label: 'Admins', active: false },
            { label: 'Guests', active: false },
          ]
        },
        { label: 'Reports', icon: <UsersIcon /> },
    ...
    headerProps: {
      title: 'Users',
      subtitle: <div>Manage your users</div>,
    ...
    <Layout {...args}>
      <Table 
        columns={[
          ...
          { header: 'Status', accessor: (user) => <StatusBadge status={user.status} /> }
        ]}
        data={users}
        hoverEffect={true}
